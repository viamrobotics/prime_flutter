          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                FilterPill(
                  label: 'Error',
                  color: PrimeTheme.of(context).colorScheme.danger,
                  isSelected: _selectedFilter == 'Error',
                  onTap: () => setState(() => _selectedFilter = 'Error'),
                ),
                FilterPill(
                  label: 'Warning',
                  color: PrimeTheme.of(context).colorScheme.warning,
                  isSelected: _selectedFilter == 'Warning',
                  onTap: () => setState(() => _selectedFilter = 'Warning'),
                ),
                FilterPill(
                  label: 'Info',
                  color: PrimeTheme.of(context).colorScheme.infoDark,
            ...
            Wrap(
              ...
              children: [
                ...
                FilterPill(
                  label: 'Debug',
                  color: PrimeTheme.of(context).colorScheme.success,
