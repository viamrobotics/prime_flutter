                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildStatusRow('CONNECTION STATUS:', const [
                          Badge(text: 'ONLINE', variant: BadgeVariant.success, icon: PrimeIcons.broadcast, showBackground: false),
                          Badge(text: 'OFFLINE', variant: BadgeVariant.danger, icon: PrimeIcons.broadcastOff, showBackground: false),
                          Badge(
                            text: 'AWAITING SETUP',
                            variant: BadgeVariant.info,
                            icon: PrimeIcons.selectionEllipse,
                  ...
                  _buildSection(
                    ...
                    child: Wrap(
                      ...
                      runSpacing: 12,
                      children: const [
                        Badge(text: 'ACTIVE', variant: BadgeVariant.success, icon: PrimeIcons.checkCircle),
                        Badge(text: 'ERROR', variant: BadgeVariant.danger, icon: PrimeIcons.alertCircle),
                        Badge(text: 'WARNING', variant: BadgeVariant.warning, icon: PrimeIcons.alertOutline),
                        Badge(text: 'INFO', variant: BadgeVariant.info, icon: PrimeIcons.information),
                        Badge(text: 'PENDING', variant: BadgeVariant.neutral, icon: PrimeIcons.clockOutline),
                      ],
                    ),
                  ),
                  ...
                  _buildSection(
                    ...
                    child: Wrap(
                      ...
                      children: const [
                        ...
                        Badge(text: 'AWAITING SETUP', variant: BadgeVariant.info, icon: PrimeIcons.selectionEllipse, showBackground: false),
