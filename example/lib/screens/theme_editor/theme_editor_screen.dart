...
class _GlobalThemeEditorState extends State<GlobalThemeEditor> {
  ...
  Map<String, Color> _getFields(PrimeColorScheme s) {
    return {
      ...
      'statusDangerBg': s.statusDangerBg,
      'statusDangerFg': s.statusDangerFg,
      'statusInfoBg': s.statusInfoBg,
      'statusInfoFg': s.statusInfoFg,
      'statusSuccessFg': s.statusSuccessFg,
      'statusWarningFg': s.statusWarningFg,
    };
  }
...
PrimeColorScheme(
  ...
  statusDangerBg: ${getColorString(s.statusDangerBg)},
  statusDangerFg: ${getColorString(s.statusDangerFg)},
  statusInfoBg: ${getColorString(s.statusInfoBg)},
  statusInfoFg: ${getColorString(s.statusInfoFg)},
  statusSuccessFg: ${getColorString(s.statusSuccessFg)},
  statusWarningFg: ${getColorString(s.statusWarningFg)},
);
''';
  }
}
...
const Map<String, Color> _primeColorsMap = {
  ...
  'dangerBg': PrimeColors.dangerBg,
  'dangerFg': PrimeColors.dangerFg,
  'infoBg': PrimeColors.infoBg,
  'infoFg': PrimeColors.infoFg,
  'successFg': PrimeColors.successFg,
  'warningFg': PrimeColors.warningFg,
